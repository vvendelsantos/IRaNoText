...
st.sidebar.markdown("""   
   <div style='text-align: justify'>
        ...
        <p>Envie textos para análise automatizada, com foco em siglas e entidades nomeadas, incluindo nomes próprios, localizações geográficas e instituições. Além disso, é possível incorporar manualmente quaisquer termos compostos relevantes para a sua pesquisa.</p>
