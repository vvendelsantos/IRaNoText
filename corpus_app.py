...
st.markdown(
    ...
    <div style="display: flex; align-items: center; justify-content: center; margin-bottom: 24px;">
        <img src="https://i.postimg.cc/kG7F8wvb/Iranotext.png" alt="IRaNoText Banner" style="width: 736px; height: 129px; border-radius: 10px;">
    </div>
    """, unsafe_allow_html=True
)
...
with tabs[2]:
    ...
    col1, col2 = st.columns([1, 2])
    with col1:
        st.image("https://i.imgur.com/yLmiVB5.png", caption="Passo 2: Análise exploratória")
    with col2:
        st.markdown("""
        <div style='background-color: rgba(30, 30, 30, 0.7); padding: 15px; border-radius: 5px; height: 165px;'>
