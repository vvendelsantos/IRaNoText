...
try:
    ...
    st.error("Erro ao carregar modelo do spaCy. Certifique-se de que pt_core_news_lg está instalado.")
...
texto_input = st.text_area("Digite ou cole o texto abaixo para análise automática:")
